...
function XM_Tooltip(t) {
    ...
    37: [function(e, t, n) {
        ...
        o && i.createCountdown({
            ...
            startDate: new Date(a.year, a.month, 1),
            targetDate: new Date(a.year, a.month + 1, 1),
            textOnly: !0,
            onStep: o.render
        })
    }, {
        ...
        ! function() {
            ...
            if (i) {
                e("../utils/content-loader").loadContent({
                    url: "https://api.instagram.com/v1/users/self/media/recent/?access_token=".concat("5796653840.f93ce4f.f8011df0a520428482635e3bd3c0ac9c"),
                    onLoading: function() {
    ...
    47: [function(e, t, n) {
        ...
        e("../utils/content-loader").loadContent({
            url: "http://www.odindesign-themes.com:3003/tweets_last/".concat(3),
            onLoading: function() {
