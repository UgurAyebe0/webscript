...
$mail->AddAddress("seven.ozan@hotmail.com"); // Mailin gönderileceği alıcı adres
						  ...
						  <tr>
							<td class="wrapper">
							  <table border="0" cellpadding="0" cellspacing="0">
								<tr>
								  <td>
									<center><img src="http://www.candycraft.net/assets/images/candy-logo.png" class="img-responsive">
									<br>
										...
										<tr>
										  <td align="center">
											<table border="0" cellpadding="0" cellspacing="0">
											  <tbody>
												<tr>
												  <td> <a href="https://www.candycraft.net/sifremiyenile.php?email='.$emailk.'&token='.$token.'" target="_blank">Doğrulama Linki</a></td>
												</tr>
											  </tbody>
											</table>
										  </td>
