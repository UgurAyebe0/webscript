...
$habereklem = '';
$hizmetlerm = '';
$anahizmeteklem = 'active'; 
$sayfa = $core->db->row("select * from anabloklar where (id = :id);",array('id' => $_REQUEST['id']));
class SimpleImage {
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Anasayfa Bloklar <span> - Blok Düzenle</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Blok Düzenle</li>
						</ul>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Anasayfa Blok Düzenle</legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="baslik_EN" value="<?php echo $sayfa['baslik_EN']; ?>" required>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea class="form-control ckeditor" name="icerik_EN"><?php echo $sayfa['icerik_EN']; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2">Link</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="link" value="<?php echo $sayfa['link']; ?>" placeholder="http://" required>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="sira" value="<?php echo $sayfa['sira']; ?>" value="0" required>
										</div>
									</div>
									
								</fieldset>
								<div class="text-right">
									<input type="submit" class="btn btn-success" style="min-width:150px;" value="Güncelle" name="yenihizmetekle">
								</div>
							</form>
						</div>
					</div>
...
if($_POST['yenihizmetekle']){
	...
	$hizmetkaydet = $core->db->query("update anabloklar set baslik = :baslik, baslik_EN = :baslik_EN, icerik = :icerik, icerik_EN = :icerik_EN, link = :link, gorsel = :gorsel, sira = :sira where (id = :id);",array('baslik' => $_POST['baslik'], 'baslik_EN' => $_POST['baslik_EN'], 'icerik' => $_POST['icerik'], 'icerik_EN' => $_POST['icerik_EN'], 'link' => $_POST['link'], 'gorsel' => $isim, 'sira' => $_POST['sira'], 'id' => $_REQUEST['id']));
	$_SESSION['yenihizmet'] = 'Blok başarıyla güncellenmiştir.';
	header('Location:anahizmetduzenle.php?id='.$_REQUEST['id']);
}
?>
					<!-- /form horizontal -->			
