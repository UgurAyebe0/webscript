...
$makale = $db->prepare("select * from anketsoru where (id = '".$_REQUEST['id']."')");
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Anketler <span> - Anket Düzenleme</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Anket Düzenleme</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title"><i class="fa fa-th-list"></i> <?php echo $makale['soru']; ?></h5>
						...
						<legend class="text-bold"><i class="fa fa-edit"></i> Anket Düzenle</legend>									
					...
					$makaleguncelle = $db->query("update anketsoru set soru = '".$_POST['soru']."' where (id = '".$_REQUEST['id']."')");	
					$_SESSION['yenisayfa'] = 'Anket güncellenmiştir.';	
					header('Location:anketduzenle.php?id='.$_REQUEST['id']);
					}
					?>
					<!-- /urunler -->
