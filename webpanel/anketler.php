...
$anketlerm = 'active';
$sayfalar = $db->query("select * from anketsoru");
?>
<script >
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Anketler <span> - Anket Listesi</h4>
						</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title"><i class="fa fa-th-list"></i> Anket Listesi</h5>
...
foreach($sayfalar as $sayfa){
				...
				echo '<ul class="icons-list">';
					echo '<li class="dropdown">';
						...
						echo '<ul class="dropdown-menu dropdown-menu-right">';
							echo '<li><a href="/webpanel/anketduzenle.php?id='.$sayfa['id'].'" class="btn btn-block btn-sm btn-primary"  style="border-radius:0px;">Düzenle</a>';
	...
	if($_POST[''.$sayfa['id'].'sil']){
		$db->query("delete from anketsoru where (id = '".$sayfa['id']."')");
		header('Location:anketler.php');
	}
	if($_POST[''.$sayfa['id'].'aktifpasif']){
		if($sayfa['yayin'] == '1'){
			$db->query("update anketsoru set yayin = '0' where (id = '".$sayfa['id']."')");
		}else{
			$db->query("update anketsoru set yayin = '1' where (id = '".$sayfa['id']."')");
		}
		header('Location:anketler.php');
	}
}
?>
	...
	<script>
function sayfasil() {
return	confirm("Seçtiğiniz anket sistemden silinecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>