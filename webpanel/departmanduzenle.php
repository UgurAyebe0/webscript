...
$sayfalarm = '';
$departmanlar = 'active';
$kategori = $db->prepare("select * from ticketkategori where (id = '".$_REQUEST['id']."')");
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Departmanlar <span> - Departman Düzenleme</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><?php echo $kategori['departman']; ?> - Departman Düzenleme</li>
						</ul>
						...
						?>		
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-edit"></i> Departman Düzenleme</legend>
									<div class="form-group">
										<label class="control-label col-lg-2">Departman Adı</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="departman" value="<?php echo $kategori['departman']; ?>" required>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2">Departman Sırası</label>
										<div class="col-lg-10">
...
if($_POST['kategoriduzenle']){
	...
	$kategorikaydet = $db->query("update ticketkategori set departman = '".$departman."', sira = '".$sira."', yayin = '1' where (id = '".$id."')");
	$_SESSION['kategoriduzenle'] = 'Departman başarıyla güncellenmiştir.';
	header('Location:departmanduzenle.php?id='.$_REQUEST['id']);
}
?>
					<!-- /form horizontal -->			
...
return	confirm("Departman güncellenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>