...
$hizmetlerm = '';
$hizmeteklem = '';
$footerhizmetduzenlem = 'active';
$hizmet = $core->db->row("select * from footermenu where (id = :id);",array('id' => $_REQUEST['id']));
class SimpleImage {
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Footer Menü <span> - Menü Düzenleme</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><?php echo $hizmet['baslik']; ?> - Footer Menu Düzenleme</li>
						</ul>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-edit"></i> Footer Menu Düzenleme</legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="baslik_EN" value="<?php echo $hizmet['baslik_EN']; ?>" required>
										</div>
									</div>
									<div class="form-group">
...
if($_POST['hizmetduzenleme']){
	...
	$hizmetkaydet = $core->db->query("update footermenu set baslik = :baslik, baslik_EN = :baslik_EN, urlkodu = :urlkodu, icerik = :icerik, gorsel = :gorsel, yayin = :yayin, stamp = :stamp, sira = :sira where (id = :id);",array('baslik' => $_POST['baslik'], 'baslik_EN' => $_POST['baslik_EN'], 'urlkodu' => $url, 'icerik' => $_POST['icerik'], 'gorsel' => $isim, 'yayin' => '1', 'stamp' => time(), 'sira' => $_POST['sira'], 'id' => $_REQUEST['id']));
	$_SESSION['hizmetduzenleme'] = 'Hizmetiniz başarıyla güncellenmiştir.';
	header('Location:footerhizmetduzenle.php?id='.$_REQUEST['id']);
}
?>
					<!-- /form horizontal -->			
