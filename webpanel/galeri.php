				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Galeri <span> - Fotoğraf Listesi</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Fotoğraf Listesi</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title"><i class="fa fa-th-list"></i> Fotoğraf Listesi</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-basic">
							...
							<tbody>
<?php 
$resimler = $core->db->query("select * from galeri");
foreach($resimler as $sayfa){
		echo '<tr>';
			echo '<td><img src="'.$core->config['global']['domain'].'assets/media/galeri/'.$sayfa['gorsel'].'" style="width:40px;height:40px;"></td>';
			echo '<td>'.$sayfa['baslik'].'</td>';
			echo '<td>'.$sayfa['aciklama'].'</td>';
		if($sayfa['yayin'] == '1'){
				...
				echo '<ul class="icons-list">';
					echo '<li class="dropdown">';
						...
						echo '<ul class="dropdown-menu dropdown-menu-right">';
							echo '<li><a href="/kodajans/webpanel/galduzenle?id='.$sayfa['id'].'" class="btn btn-block btn-sm btn-primary"  style="border-radius:0px;">Düzenle</a>';
	...
	if($_POST[''.$sayfa['id'].'sil']){
		$core->db->query("delete from galeri where (id = :id);",array('id' => $sayfa['id']));
		header('Location:galeri.php');
	}
	if($_POST[''.$sayfa['id'].'aktifpasif']){
		if($sayfa['yayin'] == '1'){
			$core->db->query("update galeri set yayin = '0' where (id = :id);",array('id' => $sayfa['id']));
		}else{
			$core->db->query("update galeri set yayin = '1' where (id = :id);",array('id' => $sayfa['id']));
		}
		header('Location:galeri.php');
	}
...
<script>
function sayfasil() {
return	confirm("Seçtiğiniz fotoğraf sistemden silinecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>