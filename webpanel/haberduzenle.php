...
$haberlerm = '';
$habereklem = '';
$haberduzenlem = 'active';
$haber = $core->db->row("select * from haberler where (id = :id);",array('id' => $_REQUEST['id']));
class SimpleImage {
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Projeler <span> - Proje Düzenleme</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><?php echo $haber['baslik']; ?> - Proje Düzenleme</li>
						</ul>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-edit"></i> Proje Düzenleme</legend>
									<div class="form-group">										<label class="control-label col-lg-2">Görsel</label>										<div class="col-lg-10">											<img src="../images/proje_resim/<?php echo $haber['gorsel']; ?>" width="200">										</div>									</div>
...
if($_POST['haberduzenle']){
	...
	$haberkaydet = $core->db->query("update haberler set baslik = :baslik, urlkodu = :urlkodu, kategori = :kategori, kisa_aciklama = :kisa_aciklama, gorsel = :gorsel, yayin = :yayin, stamp = :stamp where (id = :id);",array('baslik' => $_POST['baslik'], 'urlkodu' => $url, 'kategori' => 'haberler', 'kisa_aciklama' => $_POST['kisa_aciklama'], 'gorsel' => $isim, 'yayin' => '1', 'stamp' => time(), 'id' => $_REQUEST['id']));
	$_SESSION['haberduzenle'] = 'Projeniz başarıyla güncellenmiştir.';
	header('Location:haberduzenle.php?id='.$_REQUEST['id']);
}
?>
					<!-- /form horizontal -->			
...
<script>
function yenihaber() {
return	confirm("Proje güncellenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>