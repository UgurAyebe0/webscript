				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Kurumsal <span> - Anasayfa</h4>
						</div>
...
$hakkimizda = $core->db->row("select * from hakkimizda where (id = '1')");						
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-edit"></i> Anasayfa Kurumsal</legend>
									<div class="form-group">
										<label class="control-label col-lg-2"><span style="color:red;font-size:16px;"><i class="fa fa-youtube"></i></span> Tanıtım Videosu</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="video" value="<?php echo $hakkimizda['video']; ?>" >
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="baslik_EN" value="<?php echo $hakkimizda['baslik_EN']; ?>" required>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea class="form-control ckeditor" name="icerik_EN"><?php echo $hakkimizda['icerik_EN']; ?></textarea>
										</div>
									</div>
								</fieldset>
...
if($_POST['yenisayfaekle']){
	...
	$hakkimizdakaydet = $core->db->query("update hakkimizda set baslik = :baslik, baslik_EN = :baslik_EN, icerik = :icerik, icerik_EN = :icerik_EN, video = :video, yayin = :yayin, stamp = :stamp where (id = '1');",array('baslik' => $_POST['baslik'], 'baslik_EN' => $_POST['baslik_EN'], 'icerik' => $_POST['icerik'], 'icerik_EN' => $_POST['icerik_EN'], 'video' => $_POST['video'], 'yayin' => '1', 'stamp' => time()));
