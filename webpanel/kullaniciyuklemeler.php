				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Kullanıcı Yönetimi <span> - Yükleme Geçmişi</h4>
						</div>
...
<span class="panel-title"> 
	...
	?></span>
						...
						<table id="example" class="table table-asc0 datatable-basic">
							...
							<tbody>
<?php 
$sayfalar = $kpanel->query("select * from KrediYuklemeLog where (KullaniciId = '".$kullanici['KullaniciId']."')");
