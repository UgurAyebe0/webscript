...
$makale = $db->prepare("select * from kural where (id = '".$_REQUEST['id']."')");
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Kurallar <span> - Kural Düzenleme</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Kural Düzenleme</li>
						</ul>
						<div class="" style="float:right;padding-top:5px;padding-bottom:5px;">
							...
							<a href="/webpanel/kuralmaddeler.php" class="btn btn-primary btn-sm" style="margin-right:10px;"> Kategoriler <i class="fa fa-folder"></i></a>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<legend class="text-bold"><i class="fa fa-edit"></i> Kural Düzenle</legend>									
									
						<div class="form-group">										
						<label class="control-label col-lg-2">Madde</label>										
						<div class="col-lg-10">											
						<input type="text" class="form-control" name="soru" value="<?php echo $makale['soru']; ?>" required>
						</div>									
						</div>									
						...
						<div class="col-lg-10">											
						<textarea class="form-control ckeditor" name="cevap"><?php echo $makale['cevap']; ?></textarea>
						</div>									
						</div>	
						<div class="form-group">
...
<?php 
$kategoriler = $db->query("select * from kuralkategoriler");

$makalekat = $db->prepare("select * from kuralkategoriler where (id = '".$makale['kategori']."')");
$result = $makalekat->execute();
$makalekat   = $makalekat->fetch(PDO::FETCH_ASSOC);


echo '<option value="'.$makale['kategori'].'">'.$makalekat['kategori_TR'].'</option>';
echo '<option value="'.$makale['kategori'].'">Lütfen Kategori Seçiniz</option>';
...
?>
					...
					$makaleguncelle = $db->query("update kural set soru = '".$_POST['soru']."', cevap = '".$_POST['cevap']."', sira = '".$_POST['sira']."', kategori = '".$_POST['kategori']."' where (id = '".$_REQUEST['id']."')");	
					$_SESSION['yenisayfa'] = 'Madde güncellenmiştir.';	
					header('Location:kuralduzenle.php?id='.$_REQUEST['id']);
					}
					?>
					<!-- /urunler -->
...
<script>
function guncelle() {
return	confirm("Seçtiğiniz madde güncellenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>