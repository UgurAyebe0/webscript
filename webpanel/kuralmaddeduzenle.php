...
$sayfalarm = '';
$kurallarm = 'active';
$kategori = $db->prepare("select * from kuralkategoriler where (id = '".$_REQUEST['id']."')");
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Kurallar Yönetimi <span> - Kategori Düzenleme</h4>
						</div>
				...
				<div class="content">
					<div class="panel panel-flat">
						...
						<?php 
						if($_SESSION['ssskategoriduzenle'] != ''){
							echo '<div class="alert alert-success" role="alert">'.$_SESSION['ssskategoriduzenle'].'</div>';
							$_SESSION['ssskategoriduzenle'] = '';
						}
							...
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea class="form-control ckeditor" name="aciklama"><?php echo $kategori['aciklama']; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2">Sıra</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="sira" placeholder="Sayfadaki sırasını belirtiniz" value="<?php echo $kategori['sira']; ?>">
										</div>
									</div>
								</fieldset>
...
if($_POST['kategoriduzenle']){
	...
	$kategorikaydet = $db->query("update kuralkategoriler set kategori_TR = '".$kategoriadi."', kategorikodu = '".$url."', yayin = '1', sira = '".$sira."', aciklama = '".$aciklama."' where (id = '".$id."')");
	$_SESSION['ssskategoriduzenle'] = 'Kategoriniz başarıyla güncellenmiştir.';
	header('Location:kuralmaddeduzenle.php?id='.$_REQUEST['id']);
}
?>
					<!-- /form horizontal -->			
