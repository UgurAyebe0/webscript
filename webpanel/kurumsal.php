				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Kurumsal <span></h4>
						</div>
...
$hakkimizda = $db->prepare("select * from hakkimizda where (id = '1')");
$result = $hakkimizda->execute();
$hakkimizda   = $hakkimizda->fetch(PDO::FETCH_ASSOC);						
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-edit"></i> Kurumsal</legend>
...
if($_POST['yenisayfaekle']){
	...
	$hakkimizdakaydet = $db->query("update hakkimizda set baslik = '".$baslik."', icerik = '".$icerik."', yayin = '1', stamp = '".$zaman."' where (id = '1')");
	$_SESSION['yenisayfa'] = 'Sayfanız başarıyla güncellenmiştir.';
	header('Location:kurumsal.php');
}
?>
					<!-- /form horizontal -->			
