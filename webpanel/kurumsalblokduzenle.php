...
$habereklem = '';
$hizmetlerm = '';
$kurumsalblokduzenlem = 'active'; 
$sayfa = $core->db->row("select * from kurumsalbloklar where (id = :id);",array('id' => $_REQUEST['id']));
class SimpleImage {
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Kurumsal Bloklar <span> - Blok Düzenle</h4>
						</div>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Kurumsal Blok Düzenle</legend>
...
if($_POST['yenihizmetekle']){
	...
	$hizmetkaydet = $core->db->query("update kurumsalbloklar set baslik = :baslik, baslik_EN = :baslik_EN, icerik = :icerik, icerik_EN = :icerik_EN, gorsel = :gorsel, sira = :sira where (id = :id);",array('baslik' => $_POST['baslik'], 'baslik_EN' => $_POST['baslik_EN'], 'icerik' => $_POST['icerik'], 'icerik_EN' => $_POST['icerik_EN'], 'gorsel' => $isim, 'sira' => $_POST['sira'], 'id' => $_REQUEST['id']));
	$_SESSION['yenihizmet'] = 'Blok başarıyla güncellenmiştir.';
	header('Location:kurumsalblokduzenle.php?id='.$_REQUEST['id']);
}
?>
					<!-- /form horizontal -->			
