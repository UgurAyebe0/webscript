				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Maceraya Katıl <span></h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Maceraya Katıl</li>
						</ul>
...
$hakkimizda = $db->prepare("select * from macera where (id = '1')");
$result = $hakkimizda->execute();
$hakkimizda   = $hakkimizda->fetch(PDO::FETCH_ASSOC);						
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-edit"></i> Maceraya Katıl Sayfası</legend>

									<div class="form-group">
										<label class="control-label col-lg-2">Başlık</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="baslik" value="<?php echo $hakkimizda['baslik']; ?>" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea class="form-control ckeditor" name="icerik"><?php echo $hakkimizda['icerik']; ?></textarea>
										</div>
									</div>
...
if($_POST['yenisayfaekle']){
	...
	$hakkimizdakaydet = $db->query("update macera set baslik = '".$baslik."', icerik = '".$icerik."', yayin = '1', stamp = '".$zaman."' where (id = '1')");
	$_SESSION['yenisayfa'] = 'Sayfanız başarıyla güncellenmiştir.';
	header('Location:macerayakatil.php');
}
?>
					<!-- /form horizontal -->			
