				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Müşteri Yorumları <span> - Yorum Ekle</h4>
						</div>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Yorum Ekle</legend>
...
if($_POST['yenisayfaekle']){
	...
	$urunkaydet = $core->db->query("insert into yorumlar (adisoyadi, meslek, icerik, gorsel, yayin, stamp) values (:adisoyadi, :meslek, :icerik, :gorsel, :yayin, :stamp);",array('adisoyadi' => $_POST['adisoyadi'], 'meslek' => $_POST['meslek'], 'icerik' => $_POST['icerik'], 'gorsel' => $isim, 'yayin' => '1', 'stamp' => time()));
	$_SESSION['yenisayfa'] = 'Yorum başarıyla sisteme eklenmiştir.';
	header('Location:musteriyorumuekle.php');
}
?>
					<!-- /form horizontal -->			
...
<script>
function yenisayfa() {
return	confirm("Girdiğiniz yorum sisteme eklenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>