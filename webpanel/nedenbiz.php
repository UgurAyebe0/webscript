				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Kurumsal <span> - Neden Biz</h4>
						</div>
...
$hakkimizda = $core->db->row("select * from nedenbiz where (id = '1')");						
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-edit"></i> Neden Biz</legend>
...
if($_POST['yenisayfaekle']){
	...
	$hakkimizdakaydet = $core->db->query("update nedenbiz set icerik = :icerik, stamp = :stamp where (id = '1');",array('icerik' => $_POST['icerik'], 'stamp' => time()));
	$_SESSION['yenisayfa'] = 'Sayfanız başarıyla güncellenmiştir.';
	header('Location:nedenbiz.php');
}
?>
					<!-- /form horizontal -->			
