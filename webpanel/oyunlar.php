				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Oyunlar <span> - Oyun Listesi</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Oyun Listesi</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title"><i class="fa fa-th-list"></i> Oyun Listesi</h5>
						...
						<table class="table datatable-basic">
							...
							<tbody>
<?php 
$sayfalar = $db->query("select * from oyunlar");
foreach($sayfalar as $sayfa){
				...
				echo '<ul class="icons-list">';
					echo '<li class="dropdown">';
						...
						echo '<ul class="dropdown-menu dropdown-menu-right">';
							echo '<li><a href="/webpanel/oyunduzenleme.php?id='.$sayfa['id'].'" class="btn btn-block btn-sm btn-primary"  style="border-radius:0px;">Düzenle</a>';
	...
	if($_POST[''.$sayfa['id'].'sil']){
		$db->query("delete from oyunlar where (id = '".$sayfa['id']."')");
		header('Location:oyunlar.php');
	}
	if($_POST[''.$sayfa['id'].'aktifpasif']){
		if($sayfa['yayin'] == '1'){
			$db->query("update oyunlar set yayin = '0' where (id = '".$sayfa['id']."')");
		}else{
			$db->query("update oyunlar set yayin = '1' where (id = '".$sayfa['id']."')");
		}
		header('Location:oyunlar.php');
	}
}
...
<script>
function sayfasil() {
return	confirm("Seçtiğiniz oyun sistemden silinecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>