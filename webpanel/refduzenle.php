...
function seoUrl($kyilmaz){
 ...
 return $kyilmaz;
 }$proje = $core->db->row("select * from referanslar where (id = :id);",array('id' => $_REQUEST['id']));
?>
	<!-- Page container -->
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Referanslar <span> - Referans Düzenle</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Referans Düzenle</li>
						</ul>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-edit"></i> Referans Düzenle</legend>									<div class="form-group">										<label class="control-label col-lg-2">Görsel</label>										<div class="col-lg-10">											<img src="../images/referanslar/<?php echo $proje['gorsel']; ?>" width="200">										</div>									</div>

									<div class="form-group">
										<label class="control-label col-lg-2">Başlık TR</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="baslik" value="<?php echo $proje['baslik']; ?>" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="baslik_EN" value="<?php echo $proje['baslik_EN']; ?>" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea class="form-control ckeditor" name="aciklama"><?php echo $proje['aciklama'] ?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea class="form-control ckeditor" name="aciklama_EN"><?php echo $proje['aciklama_EN'] ?></textarea>
										</div>
									</div>
									
									<div class="form-group">
										<label class="control-label col-lg-2">Fotoğraf Değiştir</label>
										<div class="col-lg-10">
...
if($_POST['yeniurunekle']){
	...
	if($_FILES["gorsel"]["tmp_name"] != NULL){
		...
		$isim = "ref_".rand(99,99999).$uzanti;
	...
	$refkaydet = $core->db->query("update referanslar set baslik = :baslik, baslik_EN = :baslik_EN, aciklama = :aciklama, aciklama_EN = :aciklama_EN, gorsel = :gorsel where (id = :id);",array('baslik' => $_POST['baslik'], 'baslik_EN' => $_POST['baslik_EN'], 'aciklama' => $_POST['aciklama'], 'aciklama_EN' => $_POST['aciklama_EN'], 'gorsel' => $isim, 'id' => $_REQUEST['id']));
	$_SESSION['yeniurun'] = 'Referans başarıyla güncellenmiştir.';
	header('Location:refduzenle.php?id='.$_REQUEST['id']);
}
?>
...
<script>
function yeniurun() {
return	confirm("Referans güncellenmiştir, onaylıyor musunuz?");
}
</script>
</body>
</html>