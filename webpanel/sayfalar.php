				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sayfalar <span> - Sayfa Listesi</h4>
						</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title"><i class="fa fa-th-list"></i> Sayfa Listesi</h5>
...
foreach($sayfalar as $sayfa){
	...
	if($_POST[''.$sayfa['id'].'sil']){
		$db->query("delete from sayfalar where (id = '".$sayfa['id']."')");
		header('Location:sayfalar.php');
	}
	if($_POST[''.$sayfa['id'].'aktifpasif']){
		if($sayfa['yayin'] == '1'){
			$db->query("update sayfalar set yayin = '0' where (id = '".$sayfa['id']."')");
		}else{
			$db->query("update sayfalar set yayin = '1' where (id = '".$sayfa['id']."')");
		}
		header('Location:sayfalar.php');
	}
	if($_POST[''.$sayfa['id'].'duzenle']){
		header('Location:sayfaduzenle.php?p='.$sayfa['id'].'');
	}
}
?>
...
<script>
function sayfasil() {
return	confirm("Seçtiğiniz sayfa sistemden silinecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>