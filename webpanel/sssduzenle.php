...
$makale = $db->prepare("select * from sss where (id = '".$_REQUEST['id']."')");
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">S.S.S. <span> - S.S.S. Düzenleme</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">S.S.S. Düzenleme</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<legend class="text-bold"><i class="fa fa-edit"></i> S.S.S. Düzenle</legend>									
...
$makalekat = $db->prepare("select * from ssskategoriler where (id = '".$makale['kategori']."')");
...
?>
					...
					$makaleguncelle = $db->query("update sss set soru = '".$_POST['soru']."', cevap = '".$_POST['cevap']."', sira = '".$_POST['sira']."', kategori = '".$_POST['kategori']."' where (id = '".$_REQUEST['id']."')");	
					$_SESSION['yenisayfa'] = 'Soru güncellenmiştir.';	
					header('Location:sssduzenle.php?id='.$_REQUEST['id']);
					}
					?>
					<!-- /urunler -->
...
<script>
function guncelle() {
return	confirm("Seçtiğiniz soru güncellenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>