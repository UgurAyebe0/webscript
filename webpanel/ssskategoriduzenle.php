...
$sayfalarm = '';
$ssslerm = 'active';
$kategori = $db->prepare("select * from ssskategoriler where (id = '".$_REQUEST['id']."')");
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">SSS Yönetimi <span> - Kategori Düzenleme</h4>
						</div>
...
if($_POST['kategoriduzenle']){
	...
	$kategorikaydet = $db->query("update ssskategoriler set kategori_TR = '".$kategoriadi."', kategorikodu = '".$url."', yayin = '1', sira = '".$sira."' where (id = '".$id."')");
	$_SESSION['ssskategoriduzenle'] = 'Kategoriniz başarıyla güncellenmiştir.';
	header('Location:ssskategoriduzenle.php?id='.$_REQUEST['id']);
}
?>
					<!-- /form horizontal -->			
