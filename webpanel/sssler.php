...
$ssslerm = 'active';
$sayfalar = $db->query("select * from sss");
?>
<script >
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">S.S.S. <span> - S.S.S. Listesi</h4>
						</div>
					...
					<div class="breadcrumb-line">
						...
						<div class="" style="float:right;padding-top:5px;padding-bottom:5px;">
							<a href="/webpanel/sssler.php" class="btn btn-warning btn-sm" style="margin-right:10px;"> SSS Listesi <i class="fa fa-list-ul"></i></a>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title"><i class="fa fa-th-list"></i> S.S.S. Listesi</h5>
...
foreach($sayfalar as $sayfa){
				...
				echo '<ul class="icons-list">';
					echo '<li class="dropdown">';
						...
						echo '<ul class="dropdown-menu dropdown-menu-right">';
							echo '<li><a href="/webpanel/sssduzenle.php?id='.$sayfa['id'].'" class="btn btn-block btn-sm btn-primary"  style="border-radius:0px;">Düzenle</a>';
	...
	if($_POST[''.$sayfa['id'].'sil']){
		$db->query("delete from sss where (id = '".$sayfa['id']."')");
		header('Location:sssler.php');
	}
	if($_POST[''.$sayfa['id'].'aktifpasif']){
		if($sayfa['yayin'] == '1'){
			$db->query("update sss set yayin = '0' where (id = '".$sayfa['id']."')");
		}else{
			$db->query("update sss set yayin = '1' where (id = '".$sayfa['id']."')");
		}
		header('Location:sssler.php');
	}
}
