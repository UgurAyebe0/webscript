				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Anasayfa Bloklar <span> - Yeni Blok Ekle</h4>
						</div>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Anasayfa Yeni Blok Ekle</legend>
...
if($_POST['yenihizmetekle']){
	...
	$hizmetkaydet = $core->db->query("insert into anabloklar (baslik, baslik_EN, icerik, icerik_EN, link, gorsel, sira, yayin, stamp) values (:baslik, :baslik_EN, :icerik, :icerik_EN, :link, :gorsel, :sira, :yayin, :stamp);",array('baslik' => $_POST['baslik'], 'baslik_EN' => $_POST['baslik_EN'], 'icerik' => $_POST['icerik'], 'icerik_EN' => $_POST['icerik_EN'], 'link' => $_POST['link'], 'gorsel' => $isim, 'sira' => $_POST['sira'], 'yayin' => '1', 'stamp' => time()));
	$_SESSION['yenihizmet'] = 'Blok başarıyla sisteme eklenmiştir.';
	header('Location:yenianahizmet.php');
}
?>
					<!-- /form horizontal -->			
