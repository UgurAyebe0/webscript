				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Departmanlar <span> - Yeni Departman Ekle</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Yeni Departman Ekle</li>
						</ul>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Yeni Departman Ekle</legend>
...
if($_POST['yenikategoriekle']){
	...
	$kategorikaydet = $db->query("insert into ticketkategori (departman, sira, yayin) values ('$departman', '$sira', '1')");
	$_SESSION['yenikategori'] = 'Departman başarıyla sisteme eklenmiştir.';
	header('Location:yenidepartman.php');
}
?>
					<!-- /form horizontal -->			
...
return	confirm("Girdiğiniz departman sisteme eklenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>