				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Footer Menü <span> - Yeni Menü Ekle</h4>
						</div>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Yeni Menü Ekle</legend>
...
if($_POST['yenihizmetekle']){
	...
	$hizmetkaydet = $core->db->query("insert into footermenu (baslik, baslik_EN, link, yayin, stamp, sira) values (:baslik, :baslik_EN, :link, :yayin, :stamp, :sira);",array('baslik' => $_POST['baslik'], 'baslik_EN' => $_POST['baslik_EN'], 'link' => $_POST['link'], 'yayin' => '1', 'stamp' => time(), 'sira' => $_POST['sira']));
	$_SESSION['yenihizmet'] = 'Menu başarıyla sisteme eklenmiştir.';
	header('Location:yenifooterhizmet.php');
}
?>
					<!-- /form horizontal -->			
...
<script>
function yenihizmet() {
return	confirm("Girdiğiniz menu sisteme eklenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>