				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Forum Yönetimi <span> - Yeni Kategori</h4>
						</div>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Kategori Ekle</legend>

									<div class="form-group">
										<label class="control-label col-lg-2">Kategori Adı</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="kategori_TR" required>
										</div>
									</div>
...
if($_POST['yenisayfaekle']){
	...
	$urunkaydet = $db->query("insert into forumkategoriler (kategori_TR, kategorikodu, alt_id, aciklama, yayin, stamp) values ('$baslik', '$url', '$kategori', '$icerik', '$yayin', '$zaman')");
	$_SESSION['yenisayfa'] = 'Kategori başarıyla sisteme eklenmiştir.';
	header('Location:yeniforumkategori.php');
}
?>
					<!-- /form horizontal -->			
