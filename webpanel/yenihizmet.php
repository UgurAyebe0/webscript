				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Hizmetler <span> - Yeni Hizmet Ekle</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Yeni Hizmet Ekle</li>
						</ul>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Yeni Hizmet Ekle</legend>
...
if($_POST['yenihizmetekle']){
	...
	$hizmetkaydet = $core->db->query("insert into hizmetler (baslik, urlkodu, kategori, icerik, gorsel, yayin, stamp, sira) values (:baslik, :urlkodu, :kategori, :icerik, :gorsel, :yayin, :stamp, :sira);",array('baslik' => $_POST['baslik'], 'urlkodu' => $url, 'kategori' => $_POST['kategori'], 'icerik' => $_POST['icerik'], 'gorsel' => $isim, 'yayin' => '1', 'stamp' => time(), 'sira' => $_POST['sira']));
	$_SESSION['yenihizmet'] = 'Hizmetiniz başarıyla sisteme eklenmiştir.';
	header('Location:yenihizmet.php');
}
?>
					<!-- /form horizontal -->			
...
<script>
function yenihizmet() {
return	confirm("Girdiğiniz hizmet sisteme eklenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>