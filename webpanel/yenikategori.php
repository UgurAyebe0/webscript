				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Kategoriler <span> - Yeni Kategori Ekle</h4>
						</div>
...
if($_POST['yenikategoriekle']){
	...
	$kategorikaydet = $db->query("insert into kategoriler (kategori_TR, renk, kategorikodu, alt_id, stamp, yayin) values ('$kategoriadi', '$renk', '$url', '0', '$stamp', '1')");
	$_SESSION['yenikategori'] = 'Kategoriniz başarıyla sisteme eklenmiştir.';
	header('Location:yenikategori.php');
}
?>
					<!-- /form horizontal -->			
