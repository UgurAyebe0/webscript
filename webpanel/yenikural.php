				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Kurallar <span> - Yeni Madde Ekle</h4>
						</div>
					...
					<div class="breadcrumb-line">
						...
						<div class="" style="float:right;padding-top:5px;padding-bottom:5px;">
							...
							<a href="/webpanel/yenikural.php" class="btn btn-warning btn-sm" style="margin-right:10px;"> Yeni Kural <i class="fa fa-plus"></i></a>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Madde Ekle</legend>
...
if($_POST['yenisayfaekle']){
	...
	$urunkaydet = $db->query("insert into kural (soru, cevap, yayin, sira, stamp, kategori) values ('$soru', '$cevap', '1', '$sira', '$zaman', '$kategorii')");
	$_SESSION['yenisayfa'] = 'Madde başarıyla sisteme eklenmiştir.';
	header('Location:yenikural.php');
}
?>
					<!-- /form horizontal -->			
...
<script>
function yenisayfa() {
return	confirm("Girdiğiniz madde sisteme eklenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>