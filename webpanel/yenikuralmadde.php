				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Kural Kategoriler <span> - Yeni Kategori Ekle</h4>
						</div>
					...
					<div class="breadcrumb-line">
						...
						<div class="" style="float:right;padding-top:5px;padding-bottom:5px;">
							...
							<a href="/webpanel/yenikuralmadde.php" class="btn btn-warning btn-sm" style="margin-right:10px;"> Yeni Kategori <i class="fa fa-plus"></i></a>
						</div>
...
if($_POST['yenikategoriekle']){
	...
	$kategorikaydet = $db->query("insert into kuralkategoriler (kategori_TR, kategorikodu, alt_id, yayin, aciklama, sira) values ('$kategoriadi', '$url', '0', '1', '$aciklama', '$sira')");
	$_SESSION['yenikategori'] = 'Kategoriniz başarıyla sisteme eklenmiştir.';
	header('Location:yenikuralmadde.php');
}
?>
					<!-- /form horizontal -->			
