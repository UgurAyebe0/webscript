				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Markalar <span> - Yeni Marka Ekle</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Yeni Marka Ekle</li>
						</ul>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Yeni Marka Ekle</legend>
...
if($_POST['yenihaberekle']){
	...
	if($_FILES["gorsel"]["tmp_name"] != NULL){
		...
		$isim = "marka_".rand(10,9999999).$uzanti;
	...
	$haberkaydet = $core->db->query("insert markalar (baslik, urlkodu, kategori, kisa_aciklama,  gorsel, yayin, stamp) values (:baslik, :urlkodu, :kategori, :kisa_aciklama,  :gorsel, :yayin, :stamp);",array('baslik' => $_POST['baslik'], 'urlkodu' => $url, 'kategori' => 'marka', 'kisa_aciklama' => $_POST['kisa_aciklama'],  'gorsel' => $isim, 'yayin' => '1', 'stamp' => time()));
	$_SESSION['yenihaber'] = 'Marka başarıyla sisteme eklenmiştir.';
	header('Location:yenimarka.php');
}
?>
					<!-- /form horizontal -->			
...
<script>
function yenihaber() {
return	confirm("Girdiğiniz marka sisteme eklenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>