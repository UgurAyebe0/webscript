				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Oyunlar <span> - Oyun Ekle</h4>
						</div>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Oyun Ekle</legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea class="form-control" name="kisa_aciklama"></textarea>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="konu" placeholder="Hayatta Kalma, Vahşi Batı vb.">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2">Özellik</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="ozellik" placeholder="Aksiyon, Macera, Battle Royale vb.">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="file" class="btn btn-block btn-info" name="gorsel2" id="gorsel2" lang="tr" required>
										</div>
									</div>
								</fieldset>
...
if($_POST['yenisayfaekle']){
	...
	$urunkaydet = $db->query("insert into oyunlar (baslik, url, gorsel, arkaplan, kisa_aciklama, aciklama, konu, ozellik, stamp, yayin) values ('$baslik', '$url', '$isim', '$isim2', '$kisaaciklama', '$aciklama', '$konu', '$ozellik', '$zaman', '1')");
	$_SESSION['yenisayfa'] = 'Oyun başarıyla sisteme eklenmiştir.';
	header('Location:yenioyun.php');
}
?>
					<!-- /form horizontal -->			
...
<script>
function yenisayfa() {
return	confirm("Girdiğiniz oyun sisteme eklenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>