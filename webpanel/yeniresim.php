				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Galeri <span> - Yeni Resim Ekle</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Yeni Resim Ekle</li>
						</ul>
				...
				<div class="content">
					<div class="panel panel-flat">
						...
						if($_SESSION['yeniresim'] != ''){
							echo $core->bootstrap->alertBS($_SESSION['yeniresim'],"info",15,true);
							$_SESSION['yeniresim'] = '';
						}
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Yeni Resim Ekle</legend>
...
if($_POST['yeniresimekle']){
	...
	if($_FILES["gorsel"]["tmp_name"] != NULL){
		...
		$isim = "galeri_".rand(1000000,99999999999999).$uzanti;
		$konum = "../assets/media/galeri/".$isim;//resim kayıt edileceği yer.
		touch($konum);
	...
	$hizmetkaydet = $core->db->query("insert into galeri (baslik, aciklama, gorsel, yayin, stamp) values (:baslik, :aciklama, :gorsel, :yayin, :stamp);",array('baslik' => $_POST['baslik'], 'aciklama' => $_POST['aciklama'], 'gorsel' => $isim, 'yayin' => '1', 'stamp' => time()));
	$_SESSION['yeniresim'] = 'Resim başarıyla sisteme eklenmiştir.';
	header('Location:yeniresim.php');
}
?>
					<!-- /form horizontal -->			
...
<script>
function yeniresim() {
return	confirm("Girdiğiniz resim sisteme eklenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>