				...
				<div class="page-header page-header-default">
					...
					<div class="page-header-content">
						...
						<div class="page-title">
							...
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">SSS Kategoriler <span> - Yeni Kategori Ekle</h4>
					...
					<div class="breadcrumb-line">
						...
						<div class="" style="float:right;padding-top:5px;padding-bottom:5px;">
							...
							<a href="/webpanel/yenissskategori.php" class="btn btn-warning btn-sm" style="margin-right:10px;"> Yeni Kategori <i class="fa fa-plus"></i></a>
								...
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											...
											<input type="text" class="form-control" name="sira" placeholder="Sayfadaki sırasını belirtiniz">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											...
											<input type="text" class="form-control" name="icon" required="" placeholder="Sayfada Gözükecek Icon">
											<a href="https://fontawesome.com/icons?d=gallery">Iconları Buraya Tıklayarak Bulabilirsin</a>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											...
											<input type="color" class="form-control" name="renk" required="">
...
if($_POST['yenikategoriekle']){
	...
	$kategorikaydet = $db->query("insert into ssskategoriler (kategori_TR, kategorikodu, alt_id, yayin, sira, renk, icon) values ('$kategoriadi', '$url', '0', '1', '$sira','$renk','$icon')");

	$_SESSION['yenikategori'] = 'Kategoriniz başarıyla sisteme eklenmiştir.';

	header('Location:yenissskategori.php');
