				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Ürün Kategoriler <span> - Yeni Kategori Ekle</h4>
						</div>
...
if($_POST['ustkategori'] == '0'){
	...
	$kategorikaydet = $kpanel->query("insert into UrunKategorileri (KategoriAdi, AltKategori, UstKategori) values ('$kategoriadi', '$altkategori', '$ustkategori')");
	$_SESSION['yenikategori'] = 'Kategoriniz başarıyla sisteme eklenmiştir.';
	header('Location:yeniurunkategori.php');
}
?>
					<!-- /form horizontal -->			
