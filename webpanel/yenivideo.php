				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Videolar <span> - Video Ekle</h4>
						</div>
						...
						?>
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<fieldset class="content-group">
									<legend class="text-bold"><i class="fa fa-plus"></i> Video Ekle</legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="link" placeholder="Youtube Video Linki">
										</div>
									</div>
									<div class="form-group">
...
if($_POST['yenisayfaekle']){
	...
	$urunkaydet = $db->query("insert into youtube (baslik, urlkodu, link, kapak, aciklama, yukleyen, yayin, stamp, vitrin, begen, begenme, izlenme) values ('$baslik', '$url', '$link', '$isim', '$aciklama', 'CandyCraft', '1', '$zaman', '$vitrin', '0', '0', '0')");
	$_SESSION['yenisayfa'] = 'Video başarıyla sisteme eklenmiştir.';
	header('Location:yenivideo.php');
}
?>
					<!-- /form horizontal -->			
...
<script>
function yenisayfa() {
return	confirm("Girdiğiniz video sisteme eklenecektir, onaylıyor musunuz?");
}
</script>
</body>
</html>